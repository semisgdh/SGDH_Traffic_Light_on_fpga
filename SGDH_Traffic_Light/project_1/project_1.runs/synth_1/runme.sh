...
HD_PWD='C:/fpga/SGDH_Traffic_Light/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sgdh_traffic_light_top_fpga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sgdh_traffic_light_top_fpga.tcl
