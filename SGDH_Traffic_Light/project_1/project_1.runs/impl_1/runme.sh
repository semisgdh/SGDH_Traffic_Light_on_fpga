...
HD_PWD='C:/fpga/SGDH_Traffic_Light/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sgdh_traffic_light_top_fpga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sgdh_traffic_light_top_fpga.tcl -notrace
